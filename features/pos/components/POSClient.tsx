    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_430px]">
      <section className="grid gap-4">
        <motion.div
          ...
          className="rounded-3xl border border-[#ead8c5] bg-[#fffaf3]/90 px-4 py-3 shadow-[var(--shadow-card)]"
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex min-w-[220px] flex-1 items-center gap-2 rounded-2xl border border-[#ead8c5] bg-white/80 px-3 py-2">
              <svg
              ...
              <input
                ...
                className="h-8 min-w-0 flex-1 bg-transparent text-sm text-[#2c1810] outline-none placeholder:text-[#b89a7a]"
              />
            </div>
        ...
        <div className="rounded-3xl border border-[#ead8c5] bg-[#fffaf3]/70 p-3 shadow-[var(--shadow-card)]">
          {filteredProducts.length === 0 ? (
            <p className="rounded-2xl border border-dashed border-[#d8bf9f] bg-[#fff8ef] px-4 py-12 text-center text-sm text-[#8a6b58]">
